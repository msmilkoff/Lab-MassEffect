...
namespace MassEffect.Engine.Commands
{
    ...
    public class PlotJumpCommand : Command
    {
        ...
        public override void Execute(string[] commandArgs)
        {
            ...
            var destination = this.GameEngine.Galaxy
                .GetStarSystemByName(destinationName);
            ...
            Console.WriteLine(Messages.ShipTraveled, shipName,
                previousLocation.Name, destinationName);
        }
    }
}
